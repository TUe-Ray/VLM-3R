#!/bin/bash
#SBATCH --job-name=EvalGeoRoPE_ForcedFull
#SBATCH --nodes=1
...
export RUN_NAME="${RUN_NAME:-eval_geo_rope_spherical_forced_full_rope_42445435}"
export OUTPUT_PATH="${OUTPUT_PATH:-$FAST_ROOT/eval/logs/VLM3R/geo_rope_spherical_forced_full_rope_42445435}"
