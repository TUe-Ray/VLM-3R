#!/bin/bash
#SBATCH --job-name=eval_llm_vv_3d_rope_shuffle
#SBATCH --nodes=1
...
export RUN_NAME="${RUN_NAME:-eval_llm_visual_3d_rope_shuffle}"
...
export MODEL_LLM_VISUAL_3D_ROPE_SHUFFLE="${MODEL_LLM_VISUAL_3D_ROPE_SHUFFLE:-True}"
