...
export NOTE="${NOTE:-CUT3R SpatialStack timing ablation: token_mlp, dec6/9/12 -> LLM layers 1/2/3.}"
export SUFFIX="${SUFFIX:-cut3r_spatialstack_token_mlp_dec6_9_12_llm1_2_3}"
export TRAIN_RUN_NAME="${TRAIN_RUN_NAME:-cut3r_spatialstack_token_mlp_dec6_9_12_llm1_2_3_${SLURM_JOB_ID:-manual}}"
