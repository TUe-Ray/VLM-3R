...
TRAIN_RUN_NAME="${TRAIN_RUN_NAME:-${SLURM_JOB_NAME:-cut3r_spatialstack}_${SLURM_JOB_ID:-manual}}"
...
MODEL_CUT3R_SPATIALSTACK_LOG_FIRST_N="${MODEL_CUT3R_SPATIALSTACK_LOG_FIRST_N:-3}"
