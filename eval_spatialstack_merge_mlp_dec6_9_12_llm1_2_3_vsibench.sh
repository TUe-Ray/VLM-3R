#!/bin/bash
#SBATCH --job-name=Eval_CUT3R_SS_Merge123_VSI
#SBATCH --nodes=1
...
RUN_BASENAME="${RUN_BASENAME:-cut3r_spatialstack_merge_mlp_dec6_9_12_llm1_2_3}"
...
export CUT3R_SPATIALSTACK_PROJECTOR_TYPE="${CUT3R_SPATIALSTACK_PROJECTOR_TYPE:-merge_mlp}"
...
echo "==== CUT3R SpatialStack merge_mlp LLM 1/2/3 VSI-Bench eval ===="
date
...
echo "[DONE] merge_mlp eval artifacts are under: $OUTPUT_PATH"
