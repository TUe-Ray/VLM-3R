...
python "$REPO_DIR/scripts/experiments/oracle_replay_interpolation/write_execution_provenance.py" --output-path "$OUTPUT_PATH" --execution-mode single_gpu --world-size 1 --num-processes 1 --accelerate-launch-args "--num_processes 1" --phase start
...
python "$REPO_DIR/scripts/experiments/oracle_replay_interpolation/write_execution_provenance.py" --output-path "$OUTPUT_PATH" --execution-mode single_gpu --world-size 1 --num-processes 1 --accelerate-launch-args "--num_processes 1" --phase complete
