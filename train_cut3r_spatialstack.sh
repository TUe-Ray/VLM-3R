...
# General
# ============================================================
NOTE="${NOTE:-CUT3R Semi-SpatialStack dense residual injection: pre-extracted sidecars only, no pre-LLM fusion block.}"
...
MODEL_USE_CUT3R_SPATIALSTACK="${MODEL_USE_CUT3R_SPATIALSTACK:-True}"
MODEL_TUNE_CUT3R_SPATIALSTACK="${MODEL_TUNE_CUT3R_SPATIALSTACK:-True}"
MODEL_ENABLE_DUAL_PATH_SPATIAL="${MODEL_ENABLE_DUAL_PATH_SPATIAL:-False}"
MODEL_TUNE_DUAL_PATH_SPATIAL="${MODEL_TUNE_DUAL_PATH_SPATIAL:-False}"
MODEL_SPATIAL_NUM_LAYERS="${MODEL_SPATIAL_NUM_LAYERS:-3}"
MODEL_SPATIAL_SOURCE_LAYERS="${MODEL_SPATIAL_SOURCE_LAYERS:-0,1,2}"
MODEL_SPATIAL_ATTENTION_MODE="${MODEL_SPATIAL_ATTENTION_MODE:-frame_local}"
MODEL_WRITEBACK_QUERY_SCOPE="${MODEL_WRITEBACK_QUERY_SCOPE:-all_tokens}"
MODEL_WRITEBACK_VISIBILITY="${MODEL_WRITEBACK_VISIBILITY:-frame_local}"
MODEL_WRITEBACK_OUTPUT_INIT_STD="${MODEL_WRITEBACK_OUTPUT_INIT_STD:-1.0e-5}"
MODEL_SPATIAL_CHECKPOINT="${MODEL_SPATIAL_CHECKPOINT:-}"
MODEL_PRESERVE_DENSE_SPATIAL_TOKENS="${MODEL_PRESERVE_DENSE_SPATIAL_TOKENS:-True}"
MODEL_DUAL_PATH_RAW_LAYER12_CONTROL="${MODEL_DUAL_PATH_RAW_LAYER12_CONTROL:-False}"
MODEL_DUAL_PATH_POSITION_ALIGNMENT="${MODEL_DUAL_PATH_POSITION_ALIGNMENT:-exact_index}"
MODEL_DUAL_PATH_GRADIENT_CHECKPOINTING="${MODEL_DUAL_PATH_GRADIENT_CHECKPOINTING:-True}"
MODEL_SPATIAL_MLP_CHUNK_SIZE="${MODEL_SPATIAL_MLP_CHUNK_SIZE:-1024}"
MODEL_WRITEBACK_QUERY_CHUNK_SIZE="${MODEL_WRITEBACK_QUERY_CHUNK_SIZE:-512}"
...
MODEL_CUT3R_SPATIALSTACK_CROSS_ATTN_IMPL="${MODEL_CUT3R_SPATIALSTACK_CROSS_ATTN_IMPL:-torch_mha}"
MODEL_CUT3R_SPATIALSTACK_CROSS_ATTN_PATCH_ALIGN="${MODEL_CUT3R_SPATIALSTACK_CROSS_ATTN_PATCH_ALIGN:-resize}"
MODEL_CUT3R_SPATIALSTACK_CROSS_ATTN_USE_CAMERA_TOKENS="${MODEL_CUT3R_SPATIALSTACK_CROSS_ATTN_USE_CAMERA_TOKENS:-False}"
MODEL_CUT3R_SPATIALSTACK_REQUIRE_CAMERA_TOKENS="${MODEL_CUT3R_SPATIALSTACK_REQUIRE_CAMERA_TOKENS:-False}"
MODEL_CUT3R_SPATIALSTACK_CROSS_ATTN_USE_MLP="${MODEL_CUT3R_SPATIALSTACK_CROSS_ATTN_USE_MLP:-True}"
MODEL_CUT3R_SPATIALSTACK_CROSS_ATTN_NORM_TYPE="${MODEL_CUT3R_SPATIALSTACK_CROSS_ATTN_NORM_TYPE:-qwen_rmsnorm}"
MODEL_CUT3R_SPATIALSTACK_CROSS_ATTN_POS_EMBED="${MODEL_CUT3R_SPATIALSTACK_CROSS_ATTN_POS_EMBED:-sincos2d}"
MODEL_CUT3R_SPATIALSTACK_CROSS_ATTN_GAMMA_ATTN_INIT="${MODEL_CUT3R_SPATIALSTACK_CROSS_ATTN_GAMMA_ATTN_INIT:-0.05}"
MODEL_CUT3R_SPATIALSTACK_CROSS_ATTN_GAMMA_MLP_INIT="${MODEL_CUT3R_SPATIALSTACK_CROSS_ATTN_GAMMA_MLP_INIT:-0.05}"
MODEL_CUT3R_SPATIALSTACK_CROSS_ATTN_GAMMA_LEARNABLE="${MODEL_CUT3R_SPATIALSTACK_CROSS_ATTN_GAMMA_LEARNABLE:-True}"
MODEL_CUT3R_SPATIALSTACK_PREAGG_ENABLE="${MODEL_CUT3R_SPATIALSTACK_PREAGG_ENABLE:-False}"
MODEL_CUT3R_SPATIALSTACK_PREAGG_LAYERS="${MODEL_CUT3R_SPATIALSTACK_PREAGG_LAYERS:-6,9,12}"
MODEL_CUT3R_SPATIALSTACK_PREAGG_TYPE="${MODEL_CUT3R_SPATIALSTACK_PREAGG_TYPE:-weighted_sum}"
MODEL_CUT3R_SPATIALSTACK_PREAGG_PROJECTOR_SHARING="${MODEL_CUT3R_SPATIALSTACK_PREAGG_PROJECTOR_SHARING:-shared}"
MODEL_CUT3R_SPATIALSTACK_PREAGG_LOG_WEIGHTS="${MODEL_CUT3R_SPATIALSTACK_PREAGG_LOG_WEIGHTS:-True}"
MODEL_CUT3R_SPATIALSTACK_PREAGG_OUTPUT_LAYER_KEY="${MODEL_CUT3R_SPATIALSTACK_PREAGG_OUTPUT_LAYER_KEY:-preagg}"
MODEL_CUT3R_SPATIALSTACK_PREAGG_USE_LAYER_GAMMA="${MODEL_CUT3R_SPATIALSTACK_PREAGG_USE_LAYER_GAMMA:-True}"
MODEL_CUT3R_SPATIALSTACK_PREAGG_LAYER_GAMMA_INIT="${MODEL_CUT3R_SPATIALSTACK_PREAGG_LAYER_GAMMA_INIT:-1.0}"
MODEL_USE_CUT3R_CAMERA_TOKENS="${MODEL_USE_CUT3R_CAMERA_TOKENS:-False}"
MODEL_CUT3R_CAMERA_TOKEN_LAYER="${MODEL_CUT3R_CAMERA_TOKEN_LAYER:-6}"
...
MODEL_USE_POINTMAP_SUPERVISION="${MODEL_USE_POINTMAP_SUPERVISION:-False}"
MODEL_POINTMAP_HEAD_SOURCE="${MODEL_POINTMAP_HEAD_SOURCE:-llm_output}"
MODEL_POINTMAP_POINT_MAP_KEY="${MODEL_POINTMAP_POINT_MAP_KEY:-point_maps_ref}"
MODEL_LAMBDA_POINTMAP="${MODEL_LAMBDA_POINTMAP:-0.1}"
MODEL_POINTMAP_COORD_SCALE="${MODEL_POINTMAP_COORD_SCALE:-10.0}"
MODEL_POINTMAP_SMOOTH_L1_BETA="${MODEL_POINTMAP_SMOOTH_L1_BETA:-0.1}"
MODEL_POINTMAP_DETACH_HIDDEN="${MODEL_POINTMAP_DETACH_HIDDEN:-False}"
MODEL_POINTMAP_CONF_THRESHOLD="${MODEL_POINTMAP_CONF_THRESHOLD:-0.0}"
MODEL_USE_SPATIAL_BRIDGE_TOKENS="${MODEL_USE_SPATIAL_BRIDGE_TOKENS:-False}"
MODEL_NUM_SPATIAL_BRIDGE_TOKENS="${MODEL_NUM_SPATIAL_BRIDGE_TOKENS:-4}"
MODEL_USE_SPATIAL_BRIDGE_AUX_LOSS="${MODEL_USE_SPATIAL_BRIDGE_AUX_LOSS:-False}"
MODEL_LAMBDA_SPATIAL_BRIDGE="${MODEL_LAMBDA_SPATIAL_BRIDGE:-0.1}"
...
declare -A MODEL_ARGS=(
    ...
    [enable_dual_path_spatial]="$MODEL_ENABLE_DUAL_PATH_SPATIAL"
    [tune_dual_path_spatial]="$MODEL_TUNE_DUAL_PATH_SPATIAL"
    [spatial_num_layers]="$MODEL_SPATIAL_NUM_LAYERS"
    [spatial_source_layers]="$MODEL_SPATIAL_SOURCE_LAYERS"
    [spatial_attention_mode]="$MODEL_SPATIAL_ATTENTION_MODE"
    [writeback_query_scope]="$MODEL_WRITEBACK_QUERY_SCOPE"
    [writeback_visibility]="$MODEL_WRITEBACK_VISIBILITY"
    [writeback_output_init_std]="$MODEL_WRITEBACK_OUTPUT_INIT_STD"
    [spatial_checkpoint]="$MODEL_SPATIAL_CHECKPOINT"
    [preserve_dense_spatial_tokens]="$MODEL_PRESERVE_DENSE_SPATIAL_TOKENS"
    [dual_path_raw_layer12_control]="$MODEL_DUAL_PATH_RAW_LAYER12_CONTROL"
    [dual_path_position_alignment]="$MODEL_DUAL_PATH_POSITION_ALIGNMENT"
    [dual_path_gradient_checkpointing]="$MODEL_DUAL_PATH_GRADIENT_CHECKPOINTING"
    [spatial_mlp_chunk_size]="$MODEL_SPATIAL_MLP_CHUNK_SIZE"
    [writeback_query_chunk_size]="$MODEL_WRITEBACK_QUERY_CHUNK_SIZE"
    ...
    [cut3r_spatialstack_cross_attn_impl]="$MODEL_CUT3R_SPATIALSTACK_CROSS_ATTN_IMPL"
    [cut3r_spatialstack_cross_attn_patch_align]="$MODEL_CUT3R_SPATIALSTACK_CROSS_ATTN_PATCH_ALIGN"
    [cut3r_spatialstack_cross_attn_use_camera_tokens]="$MODEL_CUT3R_SPATIALSTACK_CROSS_ATTN_USE_CAMERA_TOKENS"
    [cut3r_spatialstack_require_camera_tokens]="$MODEL_CUT3R_SPATIALSTACK_REQUIRE_CAMERA_TOKENS"
    [cut3r_spatialstack_cross_attn_use_mlp]="$MODEL_CUT3R_SPATIALSTACK_CROSS_ATTN_USE_MLP"
    [cut3r_spatialstack_cross_attn_norm_type]="$MODEL_CUT3R_SPATIALSTACK_CROSS_ATTN_NORM_TYPE"
    [cut3r_spatialstack_cross_attn_pos_embed]="$MODEL_CUT3R_SPATIALSTACK_CROSS_ATTN_POS_EMBED"
    [cut3r_spatialstack_cross_attn_gamma_attn_init]="$MODEL_CUT3R_SPATIALSTACK_CROSS_ATTN_GAMMA_ATTN_INIT"
    [cut3r_spatialstack_cross_attn_gamma_mlp_init]="$MODEL_CUT3R_SPATIALSTACK_CROSS_ATTN_GAMMA_MLP_INIT"
    [cut3r_spatialstack_cross_attn_gamma_learnable]="$MODEL_CUT3R_SPATIALSTACK_CROSS_ATTN_GAMMA_LEARNABLE"
    [cut3r_spatialstack_preagg_enable]="$MODEL_CUT3R_SPATIALSTACK_PREAGG_ENABLE"
    [cut3r_spatialstack_preagg_layers]="$MODEL_CUT3R_SPATIALSTACK_PREAGG_LAYERS"
    [cut3r_spatialstack_preagg_type]="$MODEL_CUT3R_SPATIALSTACK_PREAGG_TYPE"
    [cut3r_spatialstack_preagg_projector_sharing]="$MODEL_CUT3R_SPATIALSTACK_PREAGG_PROJECTOR_SHARING"
    [cut3r_spatialstack_preagg_log_weights]="$MODEL_CUT3R_SPATIALSTACK_PREAGG_LOG_WEIGHTS"
    [cut3r_spatialstack_preagg_output_layer_key]="$MODEL_CUT3R_SPATIALSTACK_PREAGG_OUTPUT_LAYER_KEY"
    [cut3r_spatialstack_preagg_use_layer_gamma]="$MODEL_CUT3R_SPATIALSTACK_PREAGG_USE_LAYER_GAMMA"
    [cut3r_spatialstack_preagg_layer_gamma_init]="$MODEL_CUT3R_SPATIALSTACK_PREAGG_LAYER_GAMMA_INIT"
    [use_cut3r_camera_tokens]="$MODEL_USE_CUT3R_CAMERA_TOKENS"
    [cut3r_camera_token_layer]="$MODEL_CUT3R_CAMERA_TOKEN_LAYER"
    [cut3r_camera_token_init_scale]="$MODEL_CUT3R_CAMERA_TOKEN_INIT_SCALE"
    [cut3r_camera_token_projector_type]="$MODEL_CUT3R_CAMERA_TOKEN_PROJECTOR_TYPE"
    ...
    [pointmap_head_source]="$MODEL_POINTMAP_HEAD_SOURCE"
    [pointmap_point_map_key]="$MODEL_POINTMAP_POINT_MAP_KEY"
    [lambda_pointmap]="$MODEL_LAMBDA_POINTMAP"
    [pointmap_coord_scale]="$MODEL_POINTMAP_COORD_SCALE"
    [pointmap_smooth_l1_beta]="$MODEL_POINTMAP_SMOOTH_L1_BETA"
    [pointmap_detach_hidden]="$MODEL_POINTMAP_DETACH_HIDDEN"
    [pointmap_conf_threshold]="$MODEL_POINTMAP_CONF_THRESHOLD"
    [use_spatial_bridge_tokens]="$MODEL_USE_SPATIAL_BRIDGE_TOKENS"
    [num_spatial_bridge_tokens]="$MODEL_NUM_SPATIAL_BRIDGE_TOKENS"
    [use_spatial_bridge_aux_loss]="$MODEL_USE_SPATIAL_BRIDGE_AUX_LOSS"
    [lambda_spatial_bridge]="$MODEL_LAMBDA_SPATIAL_BRIDGE"
...
srun "${SRUN_FAIL_FAST_ARGS[@]}" --export=ALL torchrun \
    ...
    --rdzv_id="${SLURM_JOB_ID:-cut3r_spatialstack}" \
    --rdzv_backend=c10d \
