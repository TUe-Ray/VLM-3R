#!/bin/bash
#SBATCH --job-name=ablation_svf_pose_geometry_bridge
#SBATCH --nodes=4
...
# ============================================================
NOTE="Pi3X fusion ablation:svf_pose_geometry_bridge, 25% data, 1 epoch"
...
MODEL_FUSION_BLOCK="svf_pose_geometry_bridge"
