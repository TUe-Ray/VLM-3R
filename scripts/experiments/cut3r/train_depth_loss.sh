...
# ============================================================
NOTE="${NOTE:-Train VLM3R on VSI-Bench with CUT3R token sidecars, CUT3R point-map sidecars, cross-attention fusion, and depth-only auxiliary supervision.}"
...
# ============================================================
SUFFIX="${SUFFIX:-vlm_3r_vsibench_all_tokens_cross_attn_lora_depth_loss}"
...
MODEL_GEO_ROPE_FUSION_LOG_STATS="False"
MODEL_USE_GEOMETRY_AWARE_PROJECTION="${MODEL_USE_GEOMETRY_AWARE_PROJECTION:-False}"
...
MODEL_TUNE_GEOMETRY_AWARE_PROJECTION="${MODEL_TUNE_GEOMETRY_AWARE_PROJECTION:-False}"
MODEL_USE_BEV_SUPERVISION="False"
MODEL_BEV_HEAD_SOURCE="${MODEL_BEV_HEAD_SOURCE:-llm_output}"
MODEL_LAMBDA_BEV="${MODEL_LAMBDA_BEV:-0.05}"
MODEL_BEV_COORD_SCALE="${MODEL_BEV_COORD_SCALE:-10.0}"
MODEL_BEV_DETACH_HIDDEN="${MODEL_BEV_DETACH_HIDDEN:-False}"
MODEL_BEV_SHUFFLE_TARGET="${MODEL_BEV_SHUFFLE_TARGET:-False}"
...
MODEL_DEPTH_DETACH_HIDDEN="${MODEL_DEPTH_DETACH_HIDDEN:-False}"
MODEL_DEPTH_SHUFFLE_TARGET="${MODEL_DEPTH_SHUFFLE_TARGET:-False}"
MODEL_DEPTH_SHUFFLE_MODE="${MODEL_DEPTH_SHUFFLE_MODE:-frame_shuffle}"
MODEL_DEPTH_CONF_THRESHOLD="${MODEL_DEPTH_CONF_THRESHOLD:-0.0}"
MODEL_DEPTH_MAX_GT="${MODEL_DEPTH_MAX_GT:-20.0}"
MODEL_DEPTH_ALLOW_GENERIC_CAMERA_ASSUMED="${MODEL_DEPTH_ALLOW_GENERIC_CAMERA_ASSUMED:-False}"
MODEL_DEPTH_ALLOW_TENSOR_CAMERA_ASSUMED="${MODEL_DEPTH_ALLOW_TENSOR_CAMERA_ASSUMED:-False}"
MODEL_DEPTH_VISUALIZE_DEBUG="${MODEL_DEPTH_VISUALIZE_DEBUG:-False}"
...
echo "[BEV] ENABLE=$MODEL_USE_BEV_SUPERVISION LAMBDA_BEV=$MODEL_LAMBDA_BEV SCALE=$MODEL_BEV_COORD_SCALE SOURCE=$MODEL_BEV_HEAD_SOURCE POINT_MAP=$MODEL_BEV_POINT_MAP_KEY"
echo "[DEPTH] ENABLE=$MODEL_USE_DEPTH_SUPERVISION LAMBDA_DEPTH=$MODEL_LAMBDA_DEPTH SOURCE=$MODEL_DEPTH_HEAD_SOURCE POINT_MAP=$MODEL_DEPTH_POINT_MAP_KEY MAX_GT=$MODEL_DEPTH_MAX_GT SHUFFLE=$MODEL_DEPTH_SHUFFLE_TARGET/$MODEL_DEPTH_SHUFFLE_MODE"
...
declare -A MODEL_ARGS=(
    ...
    [bev_head_source]="$MODEL_BEV_HEAD_SOURCE"
    [lambda_bev]="$MODEL_LAMBDA_BEV"
    [bev_coord_scale]="$MODEL_BEV_COORD_SCALE"
    [bev_detach_hidden]="$MODEL_BEV_DETACH_HIDDEN"
    [bev_shuffle_target]="$MODEL_BEV_SHUFFLE_TARGET"
    [bev_visualize_debug]="$MODEL_BEV_VISUALIZE_DEBUG"
    [bev_point_map_key]="$MODEL_BEV_POINT_MAP_KEY"
    [bev_conf_threshold]="$MODEL_BEV_CONF_THRESHOLD"
    [use_depth_supervision]="$MODEL_USE_DEPTH_SUPERVISION"
    [depth_head_source]="$MODEL_DEPTH_HEAD_SOURCE"
    [lambda_depth]="$MODEL_LAMBDA_DEPTH"
    [depth_point_map_key]="$MODEL_DEPTH_POINT_MAP_KEY"
    [depth_detach_hidden]="$MODEL_DEPTH_DETACH_HIDDEN"
    [depth_shuffle_target]="$MODEL_DEPTH_SHUFFLE_TARGET"
    [depth_shuffle_mode]="$MODEL_DEPTH_SHUFFLE_MODE"
    [depth_conf_threshold]="$MODEL_DEPTH_CONF_THRESHOLD"
    [depth_max_gt]="$MODEL_DEPTH_MAX_GT"
    [depth_allow_generic_camera_assumed]="$MODEL_DEPTH_ALLOW_GENERIC_CAMERA_ASSUMED"
    [depth_allow_tensor_camera_assumed]="$MODEL_DEPTH_ALLOW_TENSOR_CAMERA_ASSUMED"
    [depth_visualize_debug]="$MODEL_DEPTH_VISUALIZE_DEBUG"
